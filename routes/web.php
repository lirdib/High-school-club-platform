...
Route::get('/dashboard/clubList', 'App\Http\Controllers\User\DashboardController@clubList');
Route::get('/dashboard/eventList', 'App\Http\Controllers\User\DashboardController@eventList');
