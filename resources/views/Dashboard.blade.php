  ...
  <div class="navBody">
    ...
    <nav class="navbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a href="/dashboard/projectForm" class="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
            ...
            <span class="link-text">Project form</span>
          </a>
        </li>

        <li class="nav-item">
          <a href="/dashboard/kerkesat" class="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
            ...
            <span class="link-text">Shiko kerkesat </span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a href="#" class="nav-link">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              class="svg-inline--fa fa-arrow-right-from-bracket fa-w-16 fa-9x"
            >
              <g class="fa-group">
                <path
                fill="currentColor"
