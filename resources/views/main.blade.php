...
<div>
    <div>
        ...
        <div class="col-4">
            ...
            <!-- student cards -->
        <h1 class="text-center mt-5">Kartat e Studentit</h1>
        <div class="container">

            <div class="row col-md-12" style="">
                @foreach ($data as $dt)
                <div class="card" style="width: 18rem; margin-left:50px; margin-top:50px; margin-bottom:100px; border-width:5px; border-color:#346ed9;">
                    <img src="..." class="card-img-top" alt="...">
                        <div class="card-body" style="">
                            <h3 class="card-title">{{$dt->emri}}  {{$dt->mbiemri}}</h3>
                            <p class="card-text">{{$dt->dega}}</p>
                            <p class="card-text">Viti {{$dt->viti}}</p>
                            <p class="card-text">Klasa {{$dt->klasa}}</p>
        ...
        <h1 class="text-center p-5 m-2"style="border:3px solid blue">Gazeta</h1>


        <h1 class="text-center mt-5" >Eventet e shkolles</h1>
     <!-- Slideshow per eventet -->
     <a href="/eventet">
